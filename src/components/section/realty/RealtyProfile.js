...
function RealtyProfile() {
  return (
    <div className="w-full lg:min-h-screen bg-white pt-8 lg:pt-12">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-[60%]">
            ...
            <p
              ...
              style={{ fontFamily: "BrandingSemibold" }}
            >
              Belief: Action is better than Words. Quit talking and lets start
              Doing!
            </p>
            ...
            <div className="space-y-10">
              <p
                ...
                style={{ fontFamily: "BrandingMedium" }}
              >
                Dharmesh is a multifaceted professional with good understanding
              ...
              <p
                ...
                style={{ fontFamily: "BrandingMedium" }}
              >
                With techno-commercial experience and working with top
                management, enables him to add value in Corporate Strategy &
                Infrastructure projects. Dharmesh is very passionate about
                whatever he does. Currently handling Special Projects, he is
                involved in Nesco's various Divisions. Dharmesh enjoys reading,
                music and spending his time with family.
              </p>
            </div>
          </div>
