...
import bannerImage from "@/assests/careers/73.png";
  ...
  const SliderData = [
    {
      image: bannerImage,
      data: (
        <div className="absolute md:top-[50%] md:left-[10%] px-20 py-6  text-white z-20 text-4xl font-branding-medium">
          <p>Be celebrated,</p>
          <p>recognised</p>
          <p>and valued.</p>
          <p className="text-secondary text-6xl">Believe</p>
