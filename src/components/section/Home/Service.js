    ...
    <section className="md:pt-[78px] pt-10 flex w-full justify-center items-center h-[100vh] goal-section1 min-h-[800px]">
      <div className=" md:w-[90%] w-[90%] relative overflow-hidden lg:h-[80%] flex items-center ">
        ...
        <div className="xl:w-[65%] md:w-[70%] z-[1] flex flex-col gap-5 py-10 xl:px-20 md:px-10 px-5 lg:h-full">
          ...
          <p
            className="xl:text-[3.2rem] lg:text-[3rem] text-[2rem] text-2xl font-bold text-primary  xl:mt-10  lg:leading-[3.5rem] leading-[2.5rem] w-[80%]"
          ...
          <p className=" md:w-[80%] lg:text-[1.47rem] text-[1.2rem] font-branding-medium leading-[2rem] ">
