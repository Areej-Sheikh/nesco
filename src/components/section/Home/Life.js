...
function Life() {
  return (
    <div className="banner-section flex lg:px-[7rem] px-5 md:px-16 justify-between items-center w-full bg-[#002172] relative pt-16 overflow-hidden lg:h-full md:h-[100vh] xl:h-[100vh]">
