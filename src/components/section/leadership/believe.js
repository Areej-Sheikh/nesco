    ...
    <section className="w-full goal-section1 relative flex flex-col items-center py-10">
      <div className=" pt-16 items-center w-[90%] mx-auto ">
        ...
        <div className="flex relative mt-20">
          <div className=" flex lg:flex-row flex-col xl:items-start items-center w-full gap-10">
            <div className="relative h-[550px] lg:w-[35%] w-full">
              <Image
                src={chessImage}
                alt="Chess Image"
                className="object-contain -mt-10 w-full h-full "
                priority
              />
            </div>
            ...
            <div className="text-justify xl:w-[50%] lg:w-[45%] w-full md:mt-0 mt-10 flex flex-col gap-5 md:text-2xl text-xl font-poppins z-10">
              <p>
                ...
                businesses grow. the focus of our
              </p>
              {/* <p className="mt-6">
              ...
              <p>
                leadership grows on converting the credo of Bellieve into
                action.
              </p>
            </div>
          </div>
