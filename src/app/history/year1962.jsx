  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="rightDiv bg-[#001F9C] sm:w-[50%] md:w-[85%] lg:w-[20%] flex relative right-[9%] lg:top-[30vh] md:top-[5vh] flex-grow h-auto"
      >
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={year1962InView ? { opacity: 1, x: 0 } : {}}
          transition={{ duration: 0.6, delay: 0.7 }}
          className="yearDiv flex flex-col relative w-auto sm:left-[40%] md:left-[40%] lg:left-[60%] text-right h-fit sm:top-10 md:top-0 lg:top-1/3 p-6"
        >
