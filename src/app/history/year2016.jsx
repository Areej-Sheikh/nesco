        ...
        >
          <div className="contentDiv flex flex-col relative gap-4 bg-cyan-400 p-12 sm:left-0 md:left-[15%] lg:left-[0%]  lg:h-[60vh] lg:top-[35vh] transition-shadow duration-300 hover:shadow-lg hover:shadow-cyan-500/50">
            ...
            <motion.p
              ...
              className=" h-fit w-fit relative text-6xl md:text-7xl lg:text-9xl font-branding-bold text-white left-2 sm:left-0 lg:left-[30%] top-2 sm:top-0 lg:top-[5vh] m-2"
            >
              {count}
              <motion.div
            ...
            <motion.div
              ...
              className="bottomText flex relative sm:w-full  md:w-full lg:w-[70%]  sm:left-0 lg:left-[30%] lg:top-[8vh] p-2"
            >
