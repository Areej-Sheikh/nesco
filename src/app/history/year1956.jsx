...
const Year1956 = () => {
  ...
  return (
    <motion.div
      ...
      className="1956Div mt-[3%] w-fit relative p-4 items-center h-fit flex flex-col md:flex-row m-4 transition-all ease-in-out duration-300 hover:translate-y-1 gap-10 ml-auto"
      data-year="1956"
      initial={{ opacity: 0, y: 50 }}
      animate={year1956InView ? { opacity: 1, y: 0 } : {}}
      transition={{ duration: 1 }}
    >
      <div className="iconDiv flex items-center justify-center relative h-fit w-fit mt-4 md:m-6">
        <Image
          src={historyThree}
          alt="Top Image"
          width={350}
