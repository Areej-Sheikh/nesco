...
const Year1986 = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[3%] md:left-4 lg:left-8 w-[90%] h-[70%] bg-blue-800 transition-shadow duration-300 hover:shadow-lg hover:shadow-blue-500/50 z-0 m-4" />
